...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = Array(Client.schema, Employee.schema, Goods.schema, Payments.schema, Position.schema, Sales.schema, User.schema).reduceLeft(_ ++ _)
