...
function $s_Lru_vivt_webapp_Main__main__AT__V(args) {
  var this$1 = $m_Lru_vivt_webapp_Main$();
...
function $f_s_App__main__AT__V($thiz, args) {
  $thiz.Lru_vivt_webapp_Main$__f_scala$App$$_args = args;
  var this$1 = $thiz.Lru_vivt_webapp_Main$__f_scala$App$$initCode;
...
function $f_s_App__$init$__V($thiz) {
  ...
  $thiz.Lru_vivt_webapp_Main$__f_executionStart = new $c_RTLong(lo, hi);
  $thiz.Lru_vivt_webapp_Main$__f_scala$App$$initCode = new $c_scm_ListBuffer()
}
...
/** @constructor */
function $c_Lru_vivt_webapp_Main$() {
  this.Lru_vivt_webapp_Main$__f_executionStart = $L0;
  this.Lru_vivt_webapp_Main$__f_scala$App$$_args = null;
  this.Lru_vivt_webapp_Main$__f_scala$App$$initCode = null;
  $n_Lru_vivt_webapp_Main$ = this;
  $f_s_App__$init$__V(this);
  var body = new $c_Lru_vivt_webapp_Main$delayedInit$body(this);
  var this$1 = this.Lru_vivt_webapp_Main$__f_scala$App$$initCode;
  this$1.addOne__O__scm_ListBuffer(body)
}
$c_Lru_vivt_webapp_Main$.prototype = new $h_O();
$c_Lru_vivt_webapp_Main$.prototype.constructor = $c_Lru_vivt_webapp_Main$;
/** @constructor */
function $h_Lru_vivt_webapp_Main$() {
  /*<skip>*/
}
$h_Lru_vivt_webapp_Main$.prototype = $c_Lru_vivt_webapp_Main$.prototype;
$c_Lru_vivt_webapp_Main$.prototype.appendPar__Lorg_scalajs_dom_raw_Node__T__V = (function(targetNode, text) {
  var parNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  parNode.textContent = text;
  targetNode.appendChild(parNode)
});
$c_Lru_vivt_webapp_Main$.prototype.delayedEndpoint$ru$vivt$webapp$Main$1__V = (function() {
  this.appendPar__Lorg_scalajs_dom_raw_Node__T__V($m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body, "Hello scalajs")
});
var $d_Lru_vivt_webapp_Main$ = new $TypeData().initClass({
  Lru_vivt_webapp_Main$: 0
}, false, "ru.vivt.webapp.Main$", {
  Lru_vivt_webapp_Main$: 1,
  O: 1,
  s_App: 1,
  s_DelayedInit: 1
});
$c_Lru_vivt_webapp_Main$.prototype.$classData = $d_Lru_vivt_webapp_Main$;
var $n_Lru_vivt_webapp_Main$;
function $m_Lru_vivt_webapp_Main$() {
  if ((!$n_Lru_vivt_webapp_Main$)) {
    $n_Lru_vivt_webapp_Main$ = new $c_Lru_vivt_webapp_Main$()
  };
  return $n_Lru_vivt_webapp_Main$
}
/** @constructor */
function $c_Lru_vivt_webapp_Main$delayedInit$body(outer) {
  this.Lru_vivt_webapp_Main$delayedInit$body__f_$outer = null;
  if ((outer === null)) {
    throw $m_sjsr_package$().unwrapJavaScriptException__jl_Throwable__O(null)
  } else {
    this.Lru_vivt_webapp_Main$delayedInit$body__f_$outer = outer
  }
}
$c_Lru_vivt_webapp_Main$delayedInit$body.prototype = new $h_sr_AbstractFunction0();
$c_Lru_vivt_webapp_Main$delayedInit$body.prototype.constructor = $c_Lru_vivt_webapp_Main$delayedInit$body;
/** @constructor */
function $h_Lru_vivt_webapp_Main$delayedInit$body() {
  /*<skip>*/
}
$h_Lru_vivt_webapp_Main$delayedInit$body.prototype = $c_Lru_vivt_webapp_Main$delayedInit$body.prototype;
$c_Lru_vivt_webapp_Main$delayedInit$body.prototype.apply__O = (function() {
  this.Lru_vivt_webapp_Main$delayedInit$body__f_$outer.delayedEndpoint$ru$vivt$webapp$Main$1__V()
});
var $d_Lru_vivt_webapp_Main$delayedInit$body = new $TypeData().initClass({
  Lru_vivt_webapp_Main$delayedInit$body: 0
}, false, "ru.vivt.webapp.Main$delayedInit$body", {
  Lru_vivt_webapp_Main$delayedInit$body: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1
});
$c_Lru_vivt_webapp_Main$delayedInit$body.prototype.$classData = $d_Lru_vivt_webapp_Main$delayedInit$body;
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_Lru_vivt_webapp_Main__main__AT__V(new ($d_T.getArrayOf().constr)([]));
}).call(this);
